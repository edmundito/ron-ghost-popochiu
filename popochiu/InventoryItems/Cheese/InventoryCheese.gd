...
const Data := preload('InventoryCheeseState.gd')

var state: Data = preload('InventoryCheese.tres')
...
func on_look() -> void:
	E.run([
		"It was a roll of \"Mozarella di Realtà\", also known as Mozarella of RON."
	])
