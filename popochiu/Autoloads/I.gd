...
const PIIPizzaBread := preload('res://popochiu/InventoryItems/PizzaBread/InventoryPizzaBread.gd')
...
var PizzaBread: PIIPizzaBread setget , get_PizzaBread
...
func get_PizzaBread(): return ._get_item_instance('PizzaBread')
